...
const directorWalker_1 = require("../file/directorWalker");
const file_1 = require("../file");
const utils_1 = require("./utils");
const checkFileIsText_1 = require("../file/checkFileIsText");
const log = require("../log");
// 获取分支最新commit
function getLatestCommitId(projectConfig, token) {
    return __awaiter(this, void 0, void 0, function* () {
        const url = api_1.getSingleBranch(projectConfig);
...
function publishFileWithCommit(publishParams) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const actions = [];
        // 先获取目标分支的树形结构
        const treeArray = yield utils_1.getBranchFileTree(Object.assign(Object.assign({}, projectConfig), { token }));
        // 删除文件
...
exports.publishFileWithCommit = publishFileWithCommit;
